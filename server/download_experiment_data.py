...
def download_view23_data():
    ...
    for backend_name in backends:
        for algorithm_name, qc in enumerate(algos):
            ...
            # print(data)
            with open('database/view3_data/{}_{}.json'.format(backend_name, algorithm_names[algorithm_name]), 'w') as fp:
                print('Saving {}_{}.json'.format(backend_name, algorithm_names[algorithm_name]))
                json.dump(data, fp)
                print('Completed')
                fp.close()
